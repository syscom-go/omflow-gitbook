...
* Application management: Correct the issue when approval is assigned according to "job rights and responsibilities". Problem with possible assignment errors 
