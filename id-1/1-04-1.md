...
* **Data collection**: Correct the line chart Problems that cannot be displayed properly
* **Reports**: Fixed the problem that reports cannot be exported during preview
